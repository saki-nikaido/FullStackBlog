...
<main className="w-full h-full">
  ...
  <div className="flex my-5">
    <Link
      href={"/blog/add"}
      className=" md:w-1/6 sm:w-2/4 text-center rounded-md p-2 m-auto bg-slate-100 font-semibold"
    >
      ブログ新規作成
    </Link>
  </div>
  <div className="w-full flex flex-col justify-center items-center">
    {posts.map((post: PostProps) => (
          <div key= {post.id} className="w-3/4 p-4 rounded-md mx-3 my-2 bg-slate-100 flex flex-col justify-center">
